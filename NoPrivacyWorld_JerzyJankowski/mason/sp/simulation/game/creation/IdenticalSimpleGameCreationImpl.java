...
public class IdenticalSimpleGameCreationImpl  implements GameCreationService {

	@Override
	public GamePair createGame(PersonAgent personAgent,
			MersenneTwisterFast random) {
		Game game1 = new Game(random, Fairness.FAIR), game2 = new Game(random, game1, personAgent.getFairness());
